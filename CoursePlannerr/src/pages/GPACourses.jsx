...
import { getGradePointsMap, getGpaScale } from "../gpaCalculator";
...
export default function Courses({
  ...
  const gpaScale = getGpaScale(universityId);
  ...
  const gradeColor = (grade) => {
    ...
    if (points === undefined) return "#64748b";
    const ratio = gpaScale > 0 ? points / gpaScale : 0;
    if (ratio >= 0.8) return "#28a745";
    if (ratio >= 0.6) return "#ffc107";
    if (ratio > 0) return "#fd7e14";
    return "#dc3545";
  };
  ...
  return (
    <div>
      ...
      <CourseForm addCourse={addCourse} universityId={universityId} />
